...
@section('title', 'Admin Tambah Event')
@section('content')
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ route('admin.event.index') }}" style="color: #E82561;" >Event</a></div>
        ...
        <div class="card mt-4">
            <form action="{{ route('admin.event.store') }}" class="needs-validation" novalidate=""
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="nama_event" type="text" class="form-control" name="nama_event" required>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="tanggal_event" type="date" class="form-control" name="tanggal_event" required>
                                <div class="invalid-feedback">
                                    Kolom ini harus diisi!
                                </div>
                            </div>
